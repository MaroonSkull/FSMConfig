...
TEST_F(CallbackRegistryTest, RegisterStateCallback) {
  ...
  registry->registerStateCallback("state1", "on_enter", [&callback_called]() { callback_called = true; });
...
TEST_F(CallbackRegistryTest, RegisterAction) {
  ...
  registry->registerAction("action1", [&action_called]() { action_called = true; });
...
TEST_F(CallbackRegistryTest, HasTransitionCallbackReturnsCorrectValue) {
  registry->registerTransitionCallback("state1", "state2", [](const TransitionEvent& e) { (void)e; });
...
TEST_F(CallbackRegistryTest, MultipleStateCallbacks) {
  ...
  registry->registerStateCallback("state1", "on_enter", [&callback1_called]() { callback1_called = true; });
  registry->registerStateCallback("state2", "on_enter", [&callback2_called]() { callback2_called = true; });
...
TEST_F(CallbackRegistryTest, MultipleActions) {
  ...
  registry->registerAction("action1", [&action1_called]() { action1_called = true; });
  registry->registerAction("action2", [&action2_called]() { action2_called = true; });
...
TEST_F(CallbackRegistryTest, OverwriteStateCallback) {
  ...
  registry->registerStateCallback("state1", "on_enter", [&first_called]() { first_called = true; });
  ...
  // Overwrite callback
  registry->registerStateCallback("state1", "on_enter", [&second_called]() { second_called = true; });
...
TEST_F(CallbackRegistryTest, OverwriteAction) {
  ...
  registry->registerAction("action1", [&first_called]() { first_called = true; });
  ...
  // Overwrite action
  registry->registerAction("action1", [&second_called]() { second_called = true; });
