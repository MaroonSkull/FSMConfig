...
class State {
 public:
   ...
   */
  [[nodiscard]] const std::map<std::string, VariableValue>& getVariables() const;

  /**
   * @brief Get on-enter callback
   * @return Callback name
   */
  [[nodiscard]] const std::string& getOnEnterCallback() const;

  /**
   * @brief Get on-exit callback
   * @return Callback name
   */
  [[nodiscard]] const std::string& getOnExitCallback() const;

  /**
   * @brief Get list of state actions
   * @return Reference to actions vector
   */
  [[nodiscard]] const std::vector<std::string>& getActions() const;
   ...
   * @return Reference to variables map
   */
  [[nodiscard]] const std::map<std::string, VariableValue>& getAllVariables() const;
