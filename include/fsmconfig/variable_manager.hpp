...
class VariableManager {
   public:
     ...
     * @param value Значение переменной
     */
    void setStateVariable(const std::string& state_name, const std::string& name,
     ...
     */
    std::optional<VariableValue> getVariable(const std::string& state_name,
     ...
     * @return Значение переменной или std::nullopt если не найдена
     */
    std::optional<VariableValue> getStateVariable(const std::string& state_name,
                                                  const std::string& name) const;
